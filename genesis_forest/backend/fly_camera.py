...
def create_forest_drone_flythrough(
    ...
    if figure_8:
        waypoints = [
            ...
            (start_x + area_x * 0.3, start_y + area_y * 0.1, height - 1),
            (start_x + area_x * 0.5, start_y + area_y * 0.5, height + 1),
            (start_x + area_x * 0.7, start_y + area_y * 0.4, height - 0.5),
            (start_x + area_x * 0.8, start_y + area_y * 0.6, height + 2),
            (start_x + area_x * 0.6, start_y + area_y * 0.8, height),
            (start_x + area_x * 0.4, start_y + area_y * 0.7, height + 1),
            (start_x + area_x * 0.2, start_y + area_y * 0.5, height - 1),
            (start_x + area_x * 0.1, start_y + area_y * 0.3, height),
            (start_x, start_y, height),
        ]
    else:
        waypoints = [
            (start_x, start_y, height),
            (start_x + area_x * 0.25, start_y + area_y * 0.2, height - 0.5),
            (start_x + area_x * 0.5, start_y + area_y * 0.3, height + 0.5),
            (start_x + area_x * 0.75, start_y + area_y * 0.5, height),
            (start_x + area_x * 0.6, start_y + area_y * 0.7, height + 1),
            (start_x + area_x * 0.4, start_y + area_y * 0.8, height - 0.5),
            (start_x + area_x * 0.2, start_y + area_y * 0.6, height),
            (start_x, start_y, height),
        ]
