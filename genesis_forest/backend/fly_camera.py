...
def create_forest_drone_flythrough(
    ...
    if figure_8:
        waypoints = [
            ...
            (start_x + area_x * 0.2, start_y + area_y * 0.15, height + 0.3),
            (start_x + area_x * 0.4, start_y + area_y * 0.3, height + 0.2),
            (start_x + area_x * 0.5, start_y + area_y * 0.5, height + 0.4),
            (start_x + area_x * 0.6, start_y + area_y * 0.7, height + 0.2),
            (start_x + area_x * 0.8, start_y + area_y * 0.8, height + 0.3),
            (start_x + area_x * 0.7, start_y + area_y * 0.6, height + 0.5),
            (start_x + area_x * 0.5, start_y + area_y * 0.4, height + 0.3),
            (start_x + area_x * 0.3, start_y + area_y * 0.5, height + 0.4),
            (start_x + area_x * 0.15, start_y + area_y * 0.35, height + 0.2),
            (start_x, start_y, height),
        ]
        look_at_waypoints = [
            (start_x + area_x * 0.1, start_y + area_y * 0.2, height - 0.5),
            (start_x + area_x * 0.3, start_y + area_y * 0.25, height - 0.3),
            (start_x + area_x * 0.5, start_y + area_y * 0.4, height - 0.2),
            (start_x + area_x * 0.6, start_y + area_y * 0.6, height - 0.3),
            (start_x + area_x * 0.9, start_y + area_y * 0.9, height - 0.2),
            (start_x + area_x * 0.8, start_y + area_y * 0.7, height - 0.1),
            (start_x + area_x * 0.6, start_y + area_y * 0.5, height - 0.2),
            (start_x + area_y * 0.4, start_y + area_y * 0.3, height - 0.3),
            (start_x + area_x * 0.4, start_y + area_y * 0.6, height - 0.2),
            (start_x + area_x * 0.2, start_y + area_y * 0.4, height - 0.3),
            (start_x + area_x * 0.1, start_y + area_y * 0.2, height - 0.5),
        ]
    else:
        waypoints = [
            (start_x, start_y, height),
            (start_x + area_x * 0.25, start_y + area_y * 0.2, height + 0.3),
            (start_x + area_x * 0.5, start_y + area_y * 0.3, height + 0.2),
            (start_x + area_x * 0.75, start_y + area_y * 0.5, height + 0.4),
            (start_x + area_x * 0.6, start_y + area_y * 0.7, height + 0.3),
            (start_x + area_x * 0.4, start_y + area_y * 0.8, height + 0.2),
            (start_x + area_x * 0.2, start_y + area_y * 0.6, height + 0.3),
            (start_x, start_y, height),
        ]
        look_at_waypoints = [
            (start_x + area_x * 0.15, start_y + area_y * 0.15, height - 0.3),
            (start_x + area_x * 0.35, start_y + area_y * 0.25, height - 0.2),
            (start_x + area_x * 0.6, start_y + area_y * 0.35, height - 0.2),
            (start_x + area_x * 0.85, start_y + area_y * 0.6, height - 0.1),
            (start_x + area_x * 0.7, start_y + area_y * 0.8, height - 0.2),
            (start_x + area_x * 0.5, start_y + area_y * 0.9, height - 0.2),
            (start_x + area_x * 0.25, start_y + area_y * 0.7, height - 0.3),
            (start_x + area_x * 0.15, start_y + area_y * 0.15, height - 0.3),
        ]
